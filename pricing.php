    ...
    <main class="main">
        ...
        <section id="pricing" class="pricing section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2></h2>
                <p>Plans That Scale With You<br></p><br>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="pricing-tem">
                            ...
                            <div class="price" id="price1">Launching Soon</div>
                            <div class="icon">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="pricing-tem">
                            ...
                            <div class="price" id="price2">Launching Soon</div>
                            <div class="icon">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                        <div class="pricing-tem">
                            ...
                            <div class="price" id="price3">Launching Soon</div>
                            <div class="icon">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                        <div class="pricing-tem">
                            ...
                            <div class="price" id="price4">Launching Soon</div>
                            <div class="icon">
