...
?>
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.php" class="d-flex align-items-center">
            <span class="sitename"><img style="max-height: 50px" src="assets/img/aimyze_logo.png" alt=""></span>
          </a>
        ...
        <div class="col-lg-4 col-md-12">
          ...
          <div class="social-links d-flex">
            ...
            <a href="https://www.linkedin.com/company/aimyze" target="_blank"><i class="bi bi-linkedin"></i></a>
          </div>
        </div>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Aimyze Pvt Ltd</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
